...
namespace _02_Ex2_AddingExitsToMaze // DECOMPOSITION OF GRAPHS 1: EXCERCISE 2 - Given an undirected graph with 𝑛 vertices and 𝑚 edges, compute the number of connected components
{
    class ConnectedComponents // the whole solution is based on STATIC method 'NumberOfComponents' as such was the provided Java template. This implies the use of STATIC FIELDS
    {
        static int NumberOfComponents(List<int>[] adj)
        {
            ...
            bool[] nodes = new bool[adj.Length];
        ...
        static void Explore(List<int>[] adj, bool[] nodes, int v) // recursive DFS method that looks around the given VERTEX and find all other connected VERTICES (direct and indirect)
        {
            nodes[v] = true;
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine(NumberOfComponents(adj)); // Good job! (Max time used: 0.06/1.50, max memory used: 8589312/536870912.)
